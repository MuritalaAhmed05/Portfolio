    ...
    <main className="overflow-hidden">
      ...
      <div className="bg-[#1D1D1D] text-white flex justify-between sm:py-9 sm:px-[10rem] relative  px-[2rem] py-5 bg-[url('html.svg')] bg-cover bg-center">
        <div className="">
          ...
          <p className="text-xs z-0">
            ...
            complex problems and transforming them into elegant, user-friendly
            solutions. In my free time, you can find me watching movie,
            continuously pushing the boundaries of my frontend expertise.
          </p>
        </div>
           </div>
      ...
      >
        <div className="space-y-11">
          ...
          <div className="flex justify-end sm:items-center flex-col">
            <div className="flex items-center">
              <Image
                src="develop.svg"
                alt="develop.svg"
            ...
            <p className="text-xs  sm:w-[500px]">
              ...
              remains up-to-date, secure, and running smoothly. From
              regular updates and bug fixes to performance optimization, I offer
